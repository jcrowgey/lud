...
fn test_circular_message() {
    let msg: [u8; 43] = [
        0xa6, 0x13, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78,
        0x61, 0x6d, 0x70, 0x6c, 0x65, 0xc0, 0x1b, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
        0x01, 0x00, 0x01, 0x00, 0x00, 0x1b, 0xc1, 0x00, 0x04, 0x5d, 0xb8, 0xd8, 0x22,
    ];
    assert!(Message::from_wire(&msg[..]).is_err());
}
...
fn test_parse_message_A() {
    ...
    let parsed = Message::from_wire(&msg[..]).unwrap();
